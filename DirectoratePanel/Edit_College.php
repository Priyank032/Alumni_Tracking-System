...
if(isset($_POST['submit']))
{
    ...
    $sql1="update college set coll_id='$id',coll_name='$name',coll_Email='$email',City='$city' where coll_id = '$cid' ";
...
if(isset($_POST['Edit'])){
  $id=$_POST['id'];
  $res=mysqli_query($db,"select * from college where coll_id='$id' ");
                    ...
                    <div class="form-style">
                        <form action="Edit_College.php" method="POST">
                            ...
                            <div class="form-group pb-3">
                                ...
                                <input type="text" required name="c_name" value="<?php echo $row['coll_name'] ?>"
                                    placeholder="College Name" class="form-control" id="c_name">
                                <!-- </label> -->
                            </div>
                            <div class="form-group pb-3">
                                <!-- <label for="clg_id">Unique College Id -->
                                <input type="email" required name="email" value="<?php echo $row['coll_Email'] ?>"
                                    placeholder="Email" class="form-control" id="Email">
                                <!-- </label> -->
                            </div>
                            <div class="form-group pb-3">
                                <!-- <label for="clg_id">Unique College Id -->
                                <input type="text" required name="c_id" value="<?php echo $row['coll_id'] ?>"
                                    placeholder="Unique College Id" class="form-control" id="clg_id">
                                <!-- </label> -->
                            </div>
                            <div class="form-group pb-3">
                                <!-- <label for="clg_id">Unique College Id -->
