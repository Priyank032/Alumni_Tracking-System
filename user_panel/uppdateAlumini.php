...
if ($_SERVER["REQUEST_METHOD"] == "POST") 
{
    ...
    //   } else{
        ...
        //   }
        $sql = "update alumni set name = '$name',rno='$rno',mobile='$phone' ,address = '$address',dob='$dob',email='$email',stat1 = '$Marry_status',sex='$sex',college='$college', year = '$year',stat2='$stat2',des='$description',Course='$course' where rno = '$ide'";
