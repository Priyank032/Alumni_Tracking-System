...
<body>
    <div class="container">
        ...
        <div class="form-outer">
            <form action="uppdateAlumini.php" method="POST">
                <div class="page slide-page">
                    ...
                    <div class="field">
                        ...
                        <input type="text" name="address" value="<?php echo $row['address']; ?>" placeholder="Full address" required />
                    </div>
                    <div class="field">
                        <div class="label">Date of Birth</div>
                        <input name="dob" type="date" value="<?php echo $row['dob']; ?>" required />
                    </div>
                    <div class="field">
                    ...
                    <div class="field">
                        ...
                        <input type="Number" name="phone" value="<?php echo $row['mobile']; ?>" placeholder="10 digit Contact Number" required />
                    </div>
                    <!-- <div class="field">
                        <div class="label">UserName</div>
                        <input type="text" name="username" value="" placeholder="Unique user id" required />
                    </div> -->
                    <div class="field">
                        <div class="label">Civil Status</div>
                        <select name="Marry_status" required >
                            <option value="<?php echo $row['stat1']; ?>"><?php echo $row['stat1']; ?></option>
                ...
                <div class="page">
                    ...
                    <div class="field">
                        ...
                        <input name="rno" type="text" readonly="true" value="<?php echo $row['rno']; ?>" required />
                    </div>
                    <div class="field">
                    ...
                    <div class="field">
                        ...
                        <select name="work" required>
                            <option value="<?php echo $row['stat2']; ?>"><?php echo $row['stat2']; ?></option>
                    ...
                    <div class="field">
                        ...
                        <input rows="80" cols="90" name="description" value="<?php echo $row['des']; ?>"
                            placeholder="Describe your present work status in minimum 50 characters like course name,college name or job description,address"></input>
                    </div>
                    <div class="field">
