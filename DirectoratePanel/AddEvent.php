...
if(isset($_POST['submit']))
{
    ...
    if(mysqli_num_rows($res)){
      echo "<script>alert('Event Id Already Exists')</script>";
    }
   else{
        mysqli_query($db,"insert into event values ('$a','$c','$d','$e',now())");
        echo "<script>alert('Event SuccessFuly Registered')</script>";
    }
      ...
      <div class="row">
          ...
          <div class="form-style">
            <form  method="POST" action="AddEvent.php">
              ...
              <div class="form-group pb-3">
                ...
                <input type="text" class="form-control" id="event_id" placeholder="Event Id" name="event_id" required>
              </div>

              <div class="form-group pb-3">
                <label for="subject">Enter Subject</label>
                <input type="text" class="form-control" id="subject" placeholder="Title" name="subject" required>
              </div>
              <div class="form-group pb-3">
                <label for="details">Enter Details</label>
                <textarea type="text" class="form-control" id="details" placeholder="Detailed Information of notice"
              ...
              <div class="row">
                <div class="col-lg-6">
                  <div class="pb-2">
                    <button type="submit" name="submit" class="btn btn-info w-100 font-weight-bold mt-2">ADD NEW EVENT</button>
                  </div>
        ...
        <div class="col-lg-4">
          ...
          <br><br><div class="col-lg-12">
            <div class="pb-2">
              <button type="submit" class="btn btn-info w-100 font-weight-bold mt-2"><a href="t.html" class="text-white">EVENTS DETAIL</a> </button>
            </div>
          </div>
