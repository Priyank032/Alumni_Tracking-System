...
if(isset($_POST['submit']))
{
    ...
    $sql1="update notice set subject = '$d', detail = '$e' where id ='$c'";
...
if(isset($_POST['Edit'])){
    $id=$_POST['id'];
    $res=mysqli_query($db,"select * from notice where id='$id' ");
                    ...
                    <div class="form-style">
                        <form method="POST" action="EditNotice.php">
                            <div class="form-group pb-3">
                                ...
                                <input type="text"  disabled value="<?php echo $row['id'] ?>" class="form-control" id="notice_id" placeholder="Enter notice id"
                                    name="notice_id" required>
                            </div>
                            <div class="form-group pb-3">
                                <label for="subject">Enter Subject</label>
                                <input type="text" class="form-control" value="<?php echo $row['subject'] ?>" id="subject" placeholder="Title" name="subject"
                                    required>
                            </div>
                            <div class="form-group pb-3">
                                <label for="details">Enter Details</label>
                                <input type="text" class="form-control" id="details"
                                    placeholder="Detailed Information of notice" value="<?php echo $row['detail'] ?>" name="details" required></input>
                            </div>
