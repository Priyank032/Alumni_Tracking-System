    ...
    <div class="mainadd">
        ...
        <div class="container">
            ...
            <div id="toolbar">
                ...
                <a href="jobs.php"><button type="button" class="btn btn-primary">Add Jobs</button></a>
                <br>
            </div>
            ...
            <table id="table" data-toggle="table" data-search="true" data-filter-control="true" data-show-export="true"
                ...
                <thead>
                    <tr>
                        ...
                        <th data-field="Updated By" data-filter-control="input" data-sortable="true">Updated By</th>
                        <th data-field="link" data-filter-control="input" data-sortable="true">Link</th>
              ...
              while( $row = mysqli_fetch_array($result))
              {
                ?>
                    <tr>
                        ...
                        <td><?php echo $row['updated by']; ?></td>
                        <td><a href="<?php echo $row['link'];?>">Applied link</a></td>
                        <td>
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                    <a class="dropdown-item" href="updatejob.php?id=<?php echo $row['id'];?>"><button
                                            type="button" class="btn btn-success">UPDATE</button></a>

                                    <a class="dropdown-item" href="deletejob.php?id=<?php echo $row['id'];?>"><button
